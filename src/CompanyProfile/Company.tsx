...
const Company = () => {
    return <div className="w-3/4">
        <div className="relative">
            ...
            <img className="w-36 h-36 rounded-3xl p-2 -bottom-1/4 absolute left-5 border-l-mine-shaft-950 border-8 bg-mine-shaft-950" src="/Icons/Google.png" alt="" />
        </div>
        ...
        <div className="px-3 mt-12">
            ...
            <div className="flex gap-1 text-lg text-mine-shaft-300 items-center">
                <IconMapPin className="h-5 w-5" stroke={1.5} />New York,US
            </div>
            <Divider my="xl" />
            <div>
