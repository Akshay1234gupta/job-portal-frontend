...
const Profile = (props: any) => {
    ...
    return <div className="w-2/3 lg-mx:w-full">
        <div className="relative">
            ...
            <div className="absolute cursor-pointer flex items-center justify-center -bottom-1/3 md-mx:-bottom-10  sm-mx:-bottom-16 left-6 !rounded-full">
        ...
        <div className="px-3 mt-16">
            <div className="text-3xl xs-mx:text-2xl font-semibold flex justify-between">{profile?.name}<Button size={matches ? "sm" : "md"} color="brightSun.4" variant="light" >Messsage</Button>
            </div>
