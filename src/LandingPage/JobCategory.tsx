...
const JobCategory = () => {
    return <div className="mt-20 pb-5">
        ...
        <div className="text-lg sm-mx:text-base xs-mx:text-sm mb-10 mx-auto text-mine-shaft-300 text-center w-1/2 sm-mx:w-11/12">Explore diverse job opportunites tailored to your skills.start your career journey today.!</div>
